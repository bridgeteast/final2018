---
title: "Abacavirinol All Participants"
author: "Bridget East"
date: "11/26/18"
...
For this project we are going to observe graphical results using barchartGC, numerical results using colPerc and rowPerc, and inferential results using chisqtestGC,and fisher.test and I will explain all of the results from each individual R block.
...
This is a bar chart that shows the treatments used and the percent of participants who were infected with aids and those who were not. It looks as though more participants infected had taken the placebo than those who took the drug. It looks like there is a twenty percent difference between the different types of treatments.
...
According to the numerical results, four percent of people who took the drug were infected, while five percent who took the placebo were infected. So it looks as if the medication was slightly effective according to colPerc. Going off of rowPerc, forty percent that were infected took the drug and almost sixty percent that were infected took the placebo, the medication looks effective.
...
It looks as though the drug is effective and we reject the null hypothesis. More participants that had gotten aids had taken the placebo then those who had taken the drug. This medication could help a lot of people and prevent the spread of aids.
